  ...
  head: () => ({
    meta: [
      ...
      { title: "Outfolio — Public case studies for OutSystems developers" },
      {
        name: "description",
        content:
          "Outfolio is the structured portfolio platform for OutSystems developers. Turn private OML projects into shareable, privacy-safe case studies.",
      },
      { name: "author", content: "Outfolio" },
